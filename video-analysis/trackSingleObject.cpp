...
int trackSingleObject(int argc, char **argv)
{
	...
	// Read video
	VideoCapture video("../data/videos/hockey.mp4");
	...
	while (video.read(frame))
	{
		...
		else
		{
			...
			putText(frame, "Tracking failure detected", Point(100, 80), FONT_HERSHEY_SIMPLEX, 0.75, Scalar(0, 0, 255),
					2);
		}
