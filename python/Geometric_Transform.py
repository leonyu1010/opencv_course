...
im[50:150,50:100,0] = 1
im[50:100,50:150,1] = 0.5
im[50:150,25:100,2] = 0.25
...
cv2.imshow("Rotate image -30 ",result)
cv2.waitKey(0)
...
# Warp image
result = cv2.warpAffine(im, warpMat, (400, 600), None, flags=cv2.INTER_LINEAR)
